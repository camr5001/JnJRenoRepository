...
export function ClientPhotosSection() {
  ...
  const categories: Record<string, CategoryPhotos> = {
    bathroom: {
      ...
      images: [
        '/assets/bathroomrealphotos/jnjbathroom1.JPG',
        '/assets/bathroomrealphotos/jnjbathroom2.JPG',
        '/assets/bathroomrealphotos/jnjbathroom3.JPG',
        '/assets/bathroomrealphotos/jnjbathroom4.JPG',
        '/assets/bathroomrealphotos/jnjbathroom5.JPG',
        '/assets/bathroomrealphotos/jnjbathroom6.JPG',
        '/assets/bathroomrealphotos/jnjbathroom7.JPG',
        '/assets/bathroomrealphotos/jnjbathroom8.JPG',
        '/assets/bathroomrealphotos/jnjbathroom9.JPG',
        '/assets/bathroomrealphotos/jnjbathroom10.JPG',
        '/assets/bathroomrealphotos/jnjbathroom11.JPG',
        '/assets/bathroomrealphotos/jnjbathroom12.JPG',
        '/assets/bathroomrealphotos/jnjbathroom13.JPG',
        '/assets/bathroomrealphotos/jnjbathroom14.JPG',
        '/assets/bathroomrealphotos/jnjbathroom15.JPG',
        '/assets/bathroomrealphotos/jnjbathroom16.JPG',
        '/assets/bathroomrealphotos/jnjbathroom17.JPG',
        '/assets/bathroomrealphotos/jnjbathroom18.JPG',
        '/assets/bathroomrealphotos/jnjbathroom19.JPG',
        '/assets/bathroomrealphotos/jnjbathroom20.JPG',
        '/assets/bathroomrealphotos/jnjbathroom21.JPG',
        '/assets/bathroomrealphotos/jnjbathroom22.JPG',
      ],
    },
    basement: {
