...
import { Calendar, MessageSquare, MapPin, Phone, Mail, Clock } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-neutral-800 mb-4">
            Let's Start Your <span className="text-primary-900">Transformation</span>
          </h2>
              ...
              <CardBody>
                {submitted && (
                  <div className="mb-6 bg-success-50 border border-success-400 text-success-600 rounded-lg p-4">
                    ...
                    <p className="text-sm mt-1">We'll contact you within 24 hours to schedule your consultation.</p>
                  </div>
                )}
